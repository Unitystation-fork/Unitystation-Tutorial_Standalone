...
public class Tutorial : MonoBehaviour
{
    ...
    {
        //load languages file
        langBot = new Lang_Bot(Path.Combine(Application.persistentDataPath, "StreamingAssets/languages/Lang_Bot_" + GameManager.Instance.language+".xml"), GameManager.Instance.language);
